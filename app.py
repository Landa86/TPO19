...
app.config['MYSQL_PASSWORD'] = ''  # Recuerda cambiar esto por tu contraseña de MySQL si es necesario
...
def submit():
    try:
        ...
        correo = request.form['email']  # Aquí se ajusta para que coincida con el nombre del campo en el HTML
